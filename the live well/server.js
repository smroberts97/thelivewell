 ...
 *
 */
const { fishRouter } = require('./controllers/fish/fish.js')
const { baitRouter } = require('./controllers/bait/bait.js')
const { invoiceRouter } = require('./controllers/invoice/invoice.js')
